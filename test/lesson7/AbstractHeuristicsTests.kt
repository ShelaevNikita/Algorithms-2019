...
abstract class AbstractHeuristicsTests {
    ...
    fun fillKnapsackCompareWithGreedyTest(fillKnapsackHeuristicsGenetic: (Int, List<Item>) -> Fill) {
        for (i in 0..9) {
            ...
            try {
                val fillHeuristics = fillKnapsackHeuristicsGenetic(1000, items)
    ...
    fun fillKnapsackCompareWithGreedyTest2(fillKnapsackHeuristicsGenetic: (Int, List<Item>) -> Fill) {
        val items1 = listOf(
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsGenetic(30, items1)
            println("Heuristics score = " + fillHeuristics.cost)
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsGenetic(13, items2)
            println("Heuristics score = " + fillHeuristics.cost)
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsGenetic(10, items3)
            println("Heuristics score = " + fillHeuristics.cost)
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsGenetic(1300, items4)
            println("Heuristics score = " + fillHeuristics.cost)
    ...
    fun fillKnapsackCompareWithDimanicTest(fillKnapsackHeuristicsGenetic: (Int, List<Item>) -> Fill) {
        var result = 0
        for (i in 0..9) {
            val items = listOf(
            ...
            try {
                val fillHeuristics = fillKnapsackHeuristicsGenetic(1160, items)
                println("Heuristics score = " + fillHeuristics.cost)
    ...
    fun fillKnapsackCompareWithGreedyTest3(fillKnapsackHeuristicsAnnealing: (Int, List<Item>) -> Fill) {
        for (i in 0..9) {
            val items = mutableListOf<Item>()
            val random = Random()
            for (j in 0 until 10000) {
            ...
            try {
                val fillHeuristics = fillKnapsackHeuristicsAnnealing(1000, items)
                println("Heuristics score = " + fillHeuristics.cost)
                val fillGreedy = fillKnapsackGreedy(1000, items)
                println("Greedy score = " + fillGreedy.cost)
                val fillDinamic = fillKnapsackDynamic(1000, items)
    ...
    fun fillKnapsackCompareWithGreedyTest4(fillKnapsackHeuristicsAnnealing: (Int, List<Item>) -> Fill) {
        val items1 = listOf(
            Item(cost = 8, weight = 10),
            Item(cost = 5, weight = 12),
            Item(cost = 6, weight = 8),
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsAnnealing(30, items1)
            println("Heuristics score = " + fillHeuristics.cost)
            val fillGreedy = fillKnapsackGreedy(30, items1)
            println("Greedy score = " + fillGreedy.cost)
            val fillDinamic = fillKnapsackDynamic(30, items1)
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsAnnealing(13, items2)
            println("Heuristics score = " + fillHeuristics.cost)
            val fillGreedy = fillKnapsackGreedy(13, items2)
            println("Greedy score = " + fillGreedy.cost)
            val fillDinamic = fillKnapsackDynamic(13, items2)
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsAnnealing(10, items3)
            println("Heuristics score = " + fillHeuristics.cost)
            val fillGreedy = fillKnapsackGreedy(10, items3)
            println("Greedy score = " + fillGreedy.cost)
            val fillDinamic = fillKnapsackDynamic(10, items3)
        ...
        try {
            val fillHeuristics = fillKnapsackHeuristicsAnnealing(1300, items4)
            println("Heuristics score = " + fillHeuristics.cost)
            val fillGreedy = fillKnapsackGreedy(1300, items4)
            println("Greedy score = " + fillGreedy.cost)
            val fillDinamic = fillKnapsackDynamic(1300, items4)
    ...
    fun fillKnapsackCompareWithDimanicTest2(fillKnapsackHeuristicsAnnealing: (Int, List<Item>) -> Fill) {
        var result = 0
        for (i in 0..9) {
            val items = listOf(
                Item(24, 1), Item(148, 13), Item(149, 476),
            ...
            try {
                val fillHeuristics = fillKnapsackHeuristicsAnnealing(1160, items)
                println("Heuristics score = " + fillHeuristics.cost)
                val fillGreedy = fillKnapsackGreedy(1160, items)
                println("Greedy score = " + fillGreedy.cost)
                val fillDinamic = fillKnapsackDynamic(1160, items)
                println("Dynamic score = " + fillDinamic.cost)
                if (fillHeuristics.cost >= fillDinamic.cost * 0.9) result++
            } catch (e: StackOverflowError) {
                println("Greedy failed with Stack Overflow")
            }
        }
